...
- **Windows Unicode Output** - Fixed IPC stdout encoding for Windows
  - Model responses containing Unicode characters (ΓëÑ, Γëñ, ΓåÆ, etc.) now display correctly
...
- **Standard** - Balanced 5-phase consensus seeking (2+ models)
  - Independent answers ΓåÆ Structured critique ΓåÆ Round-robin discussion ΓåÆ Final positions ΓåÆ Synthesis
- **Oxford** - Formal debate with FOR/AGAINST teams (even number of models)
  - Opening statements ΓåÆ Rebuttals ΓåÆ Closing statements ΓåÆ Verdict
...
- **Delphi** - Iterative expert estimation (3+ models)
  - Anonymous estimates ΓåÆ Revision rounds ΓåÆ Convergence analysis
- **Brainstorm** - Creative ideation (2+ models)
  - Diverge ΓåÆ Build on ideas ΓåÆ Converge ΓåÆ Selection
- **Tradeoff** - Multi-criteria decision analysis (2+ models)
  - Frame alternatives ΓåÆ Define criteria ΓåÆ Evaluate ΓåÆ Recommend
